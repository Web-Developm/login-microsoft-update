...
export class DataService {
  ...
  image(): Observable<any> {
    ...
    return this.http.get("https://graph.microsoft.com/beta/me/photo/$value", { responseType:'blob',
      headers: headers
    });
  }
